...
def compute_miste_single_scale(
    ...
    if if_plot_alignment:
        plot_alignment(
            ...
            y_vals=y_vals,
            grid=grid,
            x_grid=x_smoothed_supported,
            y_grid=y_smoothed_supported,
            support_x=support_x,
            support_y=support_y,
    ...
    Y_future = y_smoothed_supported[valid_idx + 1]
    Y_past = y_smoothed_supported[valid_idx]
    X_past = x_smoothed_supported[valid_idx]
